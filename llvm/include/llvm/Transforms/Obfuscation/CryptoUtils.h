...
#define SSR(x, n) RORc((x), (n))
#define R1(x, n) (((x)&0xFFFFFFFFUL) >> (n))
#define Sigma0(x) (SSR(x, 2) ^ SSR(x, 13) ^ SSR(x, 22))
#define Sigma1(x) (SSR(x, 6) ^ SSR(x, 11) ^ SSR(x, 25))
#define Gamma0(x) (SSR(x, 7) ^ SSR(x, 18) ^ R1(x, 3))
#define Gamma1(x) (SSR(x, 17) ^ SSR(x, 19) ^ R1(x, 10))
